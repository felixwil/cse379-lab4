...
ledsinputprompt:		.string "Input the value to display, number from 0-15", 0
rgbinputprompt:			.string "Input the color for RGB, 1:Red, 2:Blue, 3:Purple, 4:Green, 5:Yellow, 7:White", 0
